        ...
        <Group justify="center" mt={100}>
          <Card w={500} className={classes.card}>
            ...
            <Form action="/stucertificates" style={{ padding: '20px' }}>
              <TextInput label="Certificate-Name" required></TextInput>
              <TextInput label="Organization-Name" required mt="lg"></TextInput>
              <TextInput label="Issued-Date" required type="date" mt="lg"></TextInput>
              <TextInput label="Add File" required type="file" mt="lg"></TextInput>
