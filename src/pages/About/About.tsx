      ...
      <AppShell.Main bg="#2D3250">
        <Container fluid mx={200} py={20}>
          <Card bg="#676F9D" w="100%" h="100%" ta="center" radius={10} c="white">
            ...
            <Divider />
            <Title c="teal.4" my={10} order={4}>
              "GOD HAS PROVIDED A JOB FOR EVERY ONE & OUR JOB IS TO GET YOU ON"
            </Title>
            <Text mx={100} my={10} fz="xl">
              The Training and Placement Cell imparts training to students by giving emphasis on
              General Aptitude, Motivational Skills, Communication Skills, Interpersonal
              Relationships, Leadership Qualities, Group Discussions & Interview Techniques.
              Resource persons and professionals from reputed organizations along with college
              faculties train the students. The Training and Placement Cell also helps the weak
              students to improve their academic performance by counseling. The Training and
              Placement Cell provides the infra-structural facilities to conduct group discussions,
              tests & interviews besides catering to other logistics. The database of the students
              is managed by the cell, which plays a critical role in getting jobs to the students.
            </Text>
            <Title ta="left" mx={100} order={4} c="teal.4" my={20}>
              The primary role of the Training and Placement cell is to:
            </Title>
            <List
              spacing="xs"
              size="sm"
            ...
            >
              <List.Item>
                Prepare students for successful performance in competitive exams like
                GATE,GRE,TOEFL,CAT,GMAT, AMCAT,COCUBES etc
              </List.Item>
              <List.Item>
                {' '}
            ...
            <Title order={4} my={30} c="teal.4">
              OBJECTIVES
            </Title>
            <List type="ordered" ta="left" ml="100" fz="lg">
              <List.Item>
                To impart training in skill development, personal grooming and total personality
              ...
              <List.Item>
                To arrange different training programs, Such as mock written test, mock group
                discussion, mock interviews, personality development courses etc.
              </List.Item>
              <List.Item>
                To counsel students in choosing appropriate jobs and institutions for higher
                education.
              </List.Item>
              <List.Item>
                To conduct personality training programs outside the curricula to provide better
                placements.
              </List.Item>
